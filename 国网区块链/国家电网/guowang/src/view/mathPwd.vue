...
//          this.$refs.ruleForm2.validateField('oldpwd');
          }
          callback();
        }
      };
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
	            var data={
		         	...
		         	"card_id":this.ruleForm2.cardid,
	//	         	"oldpassword":this.ruleForm2.oldpwd,
		         "pay_password":this.ruleForm2.newpwd
		         };
		        this.$api.post("userCenter/saveNewPayPwd",data,(res)=>{
	          	if(res.status == 200){
	          		console.log(res)
	                this.$message({
		                    type: 'success',
