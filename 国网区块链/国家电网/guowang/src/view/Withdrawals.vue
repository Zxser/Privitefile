<template>
  <div class="userBasic">
    ...
    <!--<ul>
      <li><span style="margin-left: 16px;">银行卡</span>-->
      	<!--<span class="bank" ><router-link to="/UserCenter/DeleteBank">中国银行</router-link></span>-->
      ...
      <!--<li><span>兑换积分</span><input type="text" v-model="ruleForm2.integral"></li>
      <li style="margin-left: 106px;width: 717px">你好根据国家规定收购电价:0.4359元/千瓦时;国家补贴电价:0.42元/千瓦时;上海地方补贴:个人0.4元/千瓦时;企业0.25元/千瓦时。<span style="color: #079678">系统规定1度电=1积分=1元</span>。</li>
      <li><span>手机号码</span><input type="text" v-model="ruleForm2.tel"><el-button class="btn" type="button" @click="validate">获取手机验证码</el-button></li>
      <li><span style="margin-left: 15px;">验证码</span><input type="text" v-model="ruleForm2.code"></li>
      <li style="float: right;margin-right: 30%;">-->
        <!--<button class="btnSave active" type="button">保存</button>
        <button class="btnRest" type="button">取消</button>-->
        <!--<el-button class="btnSave active" type="button" @click="saveInfo()">保存</el-button>
	    <el-button class="btnRest" type="button" @click="resetForm('ruleForm2')">取消</el-button>
      </li>
    </ul>-->
  </div>
