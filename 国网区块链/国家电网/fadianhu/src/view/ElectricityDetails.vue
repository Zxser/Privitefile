<template>
  ...
  <div>
   ...
   <div class="ElectricityDetailss">
     <div class="backIndex"><a href="javascript:;" @click="home">首页</a>》<span style="color: #058675">{{name}}明细表查询</span></div>
     <div class="content">
    ...
    <div v-if="searchSign !== 1" style="margin-bottom: 30px;">
       ...
       desc(){
        ...
        interfaceArr(){
          ...
          //数据渲染
        	...
        	// 返回首页
          home(){
        	    this.$router.push({path:'/Header/HomeIndex',query:{isShowMeau:1}});
          },
          // 返回
          goBack(){
            this.$router.go();
