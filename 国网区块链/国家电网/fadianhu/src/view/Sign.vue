        ...
        <div class="signContent">
          <div>
            <div  style="margin-top: 10px;">
              <label>用户类型</label>
              <el-checkbox-group v-model="checkList" style="display: inline;margin-left: 10px;">
                <el-checkbox label="1" style="color: #fff;">个人</el-checkbox>
                <el-checkbox label="2" style="color: #fff;">企业</el-checkbox>
              </el-checkbox-group>
            </div>
          </div>
          <div>
