<template>
   ...
   <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm">
	  <el-form-item label="原密码" prop="oldpwd">
	    <el-input type="password" v-model="ruleForm2.oldpwd" style="width: 300px;height: 40px;"></el-input>
	  </el-form-item>
    ...
    export default {
      ...
      return {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$api.post("userCenter/savePwd",{"oldpassword":this.ruleForm2.oldpwd,"newpassword":this.ruleForm2.newpwd,"phone":this.ruleForm2.tel,"sign":this.ruleForm2.code},(res)=>{
          	if(res.status == 200){
                this.$message({
	                    type: 'success',
	                    message: '修改成功'
